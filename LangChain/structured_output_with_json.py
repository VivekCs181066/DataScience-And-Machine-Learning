...
JSON_structured_model = llm.with_structured_output(json_schema)
response = JSON_structured_model.invoke("""These shoes fit true to size and were comfortable right out of the box with no break-in period needed.
